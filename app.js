...
/* v0.2 — scale the entire fixed-resolution HMI as one operator panel. */
...
window.addEventListener('resize', scaleHMI, {passive:true});
window.addEventListener('orientationchange', ()=>setTimeout(scaleHMI, 120), {passive:true});
